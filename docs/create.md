...
```php
$wallet = $Blockchain->Create->createWithKey($password, $privKey, $hd='true', $email=null, $label=null);
```
...
```php
$wallet = $Blockchain->Create->create($password, $hd='true', $email=null, $label=null);
```
